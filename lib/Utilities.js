...
Utilities.bind = global.bind = function(fn, me) {
    return function() {
 ...
 * @param {String}
 */
Utilities.toXml = global.toXml = function(json, head, index) {
    var strXml = $util.isString(head) ? head : "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n";
    ...
    if(Utilities.isArray(json)) {
        index = $util.isString(index) ? index : 'item';
...
Utilities.search = global.search = function(obj, value, equal) {
